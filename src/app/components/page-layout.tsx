...
const Footer: React.FC<{}> = ({}) => {
  return (
    <footer className="px-1 py-2 absolute bottom-0 w-full bg-white">
      <hr/>
      ...
      <div>
        <div
          ...
          className="flex mx-auto rounded-full justify-center items-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
...
const PageLayoutComponent: React.FC<OwnProps> = ({ children }) => {
  return (
    <div className={`min-h-screen ${archivo.className}`}>
      <Navigation />
      <main>
      <div
        className="mb-11"
